  ...
  try {
    ...
    for (const tenant of tenants) {
      ...
      if (requestBody || requestSubject) {
        ...
        console.log(`👤 User ID: ${userId ? userId.id : 'N/A'}`);
        console.log(`📧 RequestSubject: ${requestSubject || '❌ NÃO DEFINIDO'}`);
        console.log(`📝 RequestBody: ${requestBody ? '✅ DEFINIDO (tamanho: ' + requestBody.length + ' chars)' : '❌ NÃO DEFINIDO'}`);
        if (requestSubject) {
          console.log(`   Preview: ${requestSubject.substring(0, 100)}...`);
        }
        console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
      }
    }
    ...
    if (!hasCustomTemplates) {
      console.log('✅ Nenhum tenant tem templates customizados configurados.\n');
    }
