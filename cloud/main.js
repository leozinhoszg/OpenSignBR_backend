...
import PlantAfterFind from './parsefunction/PlantAfterFind.js';
...
import addOrgUserToContactbook from './parsefunction/addOrgUserToContactbook.js';
...
import updateUser from './parsefunction/updateUser.js';
...
import verifyCertificate from './parsefunction/verifyCertificate.js';
import listPlants from './parsefunction/listPlants.js';
import getPlant from './parsefunction/getPlant.js';
import createPlant from './parsefunction/createPlant.js';
import updatePlant from './parsefunction/updatePlant.js';
import deletePlant from './parsefunction/deletePlant.js';
import getUserPlants from './parsefunction/getUserPlants.js';
import getDocumentsOverview from './parsefunction/getDocumentsOverview.js';
import getUserDocumentStatistics from './parsefunction/getUserDocumentStatistics.js';
import createTeam from './parsefunction/createTeam.js';
import updateTeam from './parsefunction/updateTeam.js';
import deleteTeam from './parsefunction/deleteTeam.js';
import getTeamDetails from './parsefunction/getTeamDetails.js';
import addUserToTeam from './parsefunction/addUserToTeam.js';
import removeUserFromTeam from './parsefunction/removeUserFromTeam.js';
import getTeamMembers from './parsefunction/getTeamMembers.js';
import searchOrgUsers from './parsefunction/searchOrgUsers.js';
...
Parse.Cloud.afterFind('OrganizationPlant', PlantAfterFind);
...
Parse.Cloud.define('addorgusertocontactbook', addOrgUserToContactbook);
...
Parse.Cloud.define('verifycertificate', verifyCertificate);
Parse.Cloud.define('listplants', listPlants);
Parse.Cloud.define('getplant', getPlant);
Parse.Cloud.define('createplant', createPlant);
Parse.Cloud.define('updateplant', updatePlant);
Parse.Cloud.define('deleteplant', deletePlant);
Parse.Cloud.define('getuserplants', getUserPlants);
Parse.Cloud.define('getdocumentsoverview', getDocumentsOverview);
Parse.Cloud.define('getuserdocumentstatistics', getUserDocumentStatistics);
Parse.Cloud.define('createteam', createTeam);
Parse.Cloud.define('updateteam', updateTeam);
Parse.Cloud.define('deleteteam', deleteTeam);
Parse.Cloud.define('getteamdetails', getTeamDetails);
Parse.Cloud.define('addusertoteam', addUserToTeam);
Parse.Cloud.define('removeuserfromteam', removeUserFromTeam);
Parse.Cloud.define('getteammembers', getTeamMembers);
Parse.Cloud.define('searchorgusers', searchOrgUsers);
